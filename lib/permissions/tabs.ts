...
export const PERMISSION_LABELS: Record<PermissionKey, { label: string; group: string }> = {
  ...
  administration: { label: 'HC-NS', group: 'Tab chính' },
  ...
  'coordination.findings5s': { label: 'Kho nguyên phụ liệu', group: 'Điều Phối' },
  ...
  'administration.hr-status': { label: 'Đổi trạng thái NS (trưởng xưởng↑)', group: 'HC-NS' },
