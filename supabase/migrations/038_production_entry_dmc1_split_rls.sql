-- ============================================================
-- 038: Scope DMC1 production-entry insert RLS by DESCRIPTION
-- Keeps DMC1 aggregate access while allowing DMC1-CT/PK/PU sub-workspaces.
-- ============================================================
...
CREATE POLICY "production_insert_workshop_allowed" ON "Production"
  ...
  WITH CHECK (
    check_production_insert_permission(pcode, totalem)
  );
