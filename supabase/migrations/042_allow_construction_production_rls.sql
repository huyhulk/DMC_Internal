-- ============================================================
-- 042: Allow construction-site production entry in Production RLS
-- Adds CONG_TRINH support to check_production_insert_permission()
-- without editing prior applied migration 038.
-- ============================================================
